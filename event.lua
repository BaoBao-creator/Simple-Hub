...
local feeding = false
local eventshop = {"All", "Sprout Seed Pack", "Sprout Egg", "Mandrake Seed", "Sprout Crate", "Silver Fertilizer", "Canary Melon Seed", "Amberheart", "Spriggan", "Skyroot Chest", "Can Of Beans", "Griffin Statue", "Bouncy Mushroom", "}
